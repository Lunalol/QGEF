...
//
			...
			const sprint1942 = dojo.place(this.bgagame.format_block('QGEFroundTrackBLACK', {round: 4, season: this.translate.spring, year: 1942}), QGEFroundTrack);
			dojo.place(`<img draggable='false' style='position:absolute;top:12px;left:-6px;width:26px;' src='${g_gamethemeurl}img/svg/Advance.svg'>`, sprint1942);
			dojo.place(`<img draggable='false' style='position:absolute;top:10px;left:-10px;width:30px;' src='${g_gamethemeurl}img/svg/forbidden.svg'>`, sprint1942);
			...
			dojo.place(this.bgagame.format_block('QGEFroundTrackYELLOW', {text: this.translate.scoring}), QGEFroundTrack);
			const sprint1943 = dojo.place(this.bgagame.format_block('QGEFroundTrackBLACK', {round: 8, season: this.translate.spring, year: 1943}), QGEFroundTrack);
			dojo.place(`<img draggable='false' style='position:absolute;top:12px;left:-6px;width:26px;' src='${g_gamethemeurl}img/svg/Advance.svg'>`, sprint1943);
			dojo.place(`<img draggable='false' style='position:absolute;top:10px;left:-10px;width:30px;' src='${g_gamethemeurl}img/svg/forbidden.svg'>`, sprint1943);
			...
			dojo.place(this.bgagame.format_block('QGEFroundTrackYELLOW', {text: this.translate.scoring}), QGEFroundTrack);
			const sprint1944 = dojo.place(this.bgagame.format_block('QGEFroundTrackBLACK', {round: 12, season: this.translate.spring, year: 1944}), QGEFroundTrack);
			dojo.place(`<img draggable='false' style='position:absolute;top:12px;left:-6px;width:26px;' src='${g_gamethemeurl}img/svg/Advance.svg'>`, sprint1944);
			dojo.place(`<img draggable='false' style='position:absolute;top:10px;left:-10px;width:30px;' src='${g_gamethemeurl}img/svg/forbidden.svg'>`, sprint1944);
			...
			const sprint1945 = dojo.place(this.bgagame.format_block('QGEFroundTrackBLACK', {round: 16, season: this.translate.spring, year: 1945}), QGEFroundTrack);
			dojo.place(`<img draggable='false' style='position:absolute;top:12px;left:-6px;width:26px;' src='${g_gamethemeurl}img/svg/Advance.svg'>`, sprint1945);
